...
class ResNext50_32x4d(nn.Module):
    output_shape = (2048, 7, 3)  # Ottenuta guardando all'architettura della rete
    def __init__(self, weights=models.ResNeXt50_32X4D_Weights.IMAGENET1K_V2, trainable=True):
        super(ResNext50_32x4d, self).__init__()
        self.resnet = models.resnext50_32x4d(weights=weights)
        # Elimino i layer lineari e gli AdaptiveAvgPoll2d Layer
        self.features = nn.Sequential(*list(self.resnet.children())[:-2])
    ...
    def get_required_tranform(self):
        return models.ResNeXt50_32X4D_Weights.IMAGENET1K_V2.transforms()
...
class EfficientNetB4(nn.Module):
    ...
    output_shape = (1792, 17, 17)  # Ottenuta guardando all'architettura della rete
    def __init__(self, weights=models.EfficientNet_B4_Weights.DEFAULT, trainable=False):
    ...
    def get_required_tranform(self):
        return models.EfficientNet_B4_Weights.IMAGENET1K_V1.transforms()
